...
import { createAppUser, linkUserToDriver } from "@/lib/admin-users.functions";
...
const MODULES: { key: ModuleKey; label: string }[] = [
  ...
  { key: "tvde", label: "TVDE" }, { key: "acerto_carro", label: "Acerto do Carro" },
  { key: "painel_motorista", label: "Painel do Motorista" }, { key: "financeiro", label: "Financeiro" },
