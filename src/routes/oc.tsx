      ...
      <Card>
        <Table>
          ...
          <TableBody>
            ...
            {data.length === 0 && <TableRow><TableCell colSpan={10} className="text-center py-8 text-muted-foreground">Nenhuma OC ainda. Aprove uma proposta para gerar automaticamente.</TableCell></TableRow>}
          </TableBody>
        </Table>
      </Card>
